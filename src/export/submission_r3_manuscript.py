"""Self-contained, scientifically bounded R3 main manuscript (generated inputs)."""
...
def write_main(directory):
    directory=Path(directory);directory.mkdir(exist_ok=True)
    (directory/'DLG-StreamMC_submission_r3.tex').write_text(MAIN)
