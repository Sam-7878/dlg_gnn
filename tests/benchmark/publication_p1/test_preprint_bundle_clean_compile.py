#!/usr/bin/env python3
"""
test_preprint_bundle_clean_compile.py

Round P1 Freeze Gate: Verifies that the Preprints.org submission archive
(publication/benchmark/preprints/DLG_Benchmark_Preprints_Submission.zip) unpacks into an isolated
environment and compiles cleanly with 0 errors via 4-pass compilation
...
def test_preprint_zip_structure():
