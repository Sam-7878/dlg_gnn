...
Ensures both dlg_gnn root, its src directory, and its parent (goat_bank) are in sys.path
so all package imports (`import dlg_gnn...`, `import experiments...`, `import src...`, `import gog_fraud...`)
